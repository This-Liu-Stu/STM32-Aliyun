...
/* USER CODE BEGIN 1 */
/* USART1 send function */
void USART1_Send(const char *fmt, ...)
{
	 char buffer[256]; // 创建一个足够大的缓冲区
    va_list args; // 声明一个 va_list 类型的变量

    va_start(args, fmt); // 初始化 va_list
...
/* USART2 send function */
void USART2_Send(const char *fmt, ...)
{
		char buffer[256]; // 创建一个足够大的缓冲区
    va_list args; // 声明一个 va_list 类型的变量
...
void USART3_Send(const char *fmt, ...)
{
		char buffer[256]; // 创建一个足够大的缓冲区
    va_list args; // 声明一个 va_list 类型的变量
